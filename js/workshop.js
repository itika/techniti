...
setTimeout(function ()
{
	dp.init(
	{
		...
		page: [
		{ // page 1
			backgroundImage: "rc_plane.jpg",
			menuBackgroundColor: { r: 91, g: 67, b: 189 },
			text: [
				{
					html: ' ',
					x: 0, y: 2, w: 2, h: 2
		...
		{ // page 3
			backgroundImage: "humanoidrobots.jpg",
